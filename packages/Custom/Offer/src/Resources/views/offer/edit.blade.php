...
<div class="content">
    ...
    <form method="POST" action="{{route('updateOffer', [$offers->id])}}" enctype="multipart/form-data" @submit.prevent="onSubmit">
        ...
        <div class="page-content">
            ...
            <div class="form-container">
                ...
                <div class="control-group" :class="[errors.has('image') ? 'has-error' : '']">
                    ...
                    <div class="preview">
                        <img src="{{ asset('uploadImages/offer/'.$offers->image) }}" id="file-ip-1-preview" alt="{{ __('offer::app.offer.image') }}" height="70" width="110">
                    </div>
                    <div>
