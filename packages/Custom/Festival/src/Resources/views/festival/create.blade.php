        ...
        <div class="page-content">
            ...
            <div class="form-container">
                ...
                <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                    <label for="title" class="required">{{ __('festival::app.festival.offer-title') }}</label>
                ...
                <div class="control-group" :class="[errors.has('desc') ? 'has-error' : '']">
                    <label for="desc" class="required">{{ __('festival::app.festival.desc') }}</label>
                ...
                <div class="control-group" :class="[errors.has('status') ? 'has-error' : '']">
                    <label for="status" class="required">{{ __('festival::app.festival.offer-status') }}</label>
