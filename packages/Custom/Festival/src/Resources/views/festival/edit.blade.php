        ...
        <div class="page-content">
            <div class="form-container">
                ...
                <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                    ...
                    <input type="text" class="control" name="title" value="{{$festival['title']}}" v-validate="'required'" data-vv-as="&quot;{{ __('festival::app.festival.festival-title') }}&quot;">
                 ...
                 <div class="control-group" :class="[errors.has('short_desc') ? 'has-error' : '']">
                    ...
                    <textarea type="text" class="control" name="short_desc" placeholder="Enter short description here" v-validate="'required'" data-vv-as="&quot;{{ __('festival::app.festival.short_desc') }}&quot;">{{$festival['short_desc']}}</textarea>
                ...
                <div class="control-group" :class="[errors.has('long_desc') ? 'has-error' : '']">
                    ...
                    <textarea type="text" class="control" name="long_desc" placeholder="Enter long description here" v-validate="'required'" data-vv-as="&quot;{{ __('festival::app.festival.long_desc') }}&quot;">{{$festival['long_desc']}}</textarea>
                ...
                <div class="control-group" :class="[errors.has('image') ? 'has-error' : '']">
                    ...
                    <div class="preview">
                        <img src="{{ asset($festival['image']) }}" id="file-ip-1-preview" alt="{{ __('festival::app.festival.image') }}" height="30%" width="35%">
                    </div>
                    <div>
                        <input type="file" name="image" v-validate="''" id="file-ip-1" accept="image/*" onchange="showPreview(event);" data-vv-as="&quot;{{ __('festival::app.festival.image') }}&quot;">
                    </div>
                ...
                <div class="control-group" :class="[errors.has('start_date') ? 'has-error' : '']">
                    ...
                    <input type="date" class="control" name="start_date" value="{{$festival['start_date']}}"  v-validate="'required'" data-vv-as="&quot;{{ __('festival::app.festival.start-date') }}&quot;">
                ...
                <div class="control-group" :class="[errors.has('end_date') ? 'has-error' : '']">
                    ...
                    <input type="date" class="control" name="end_date" value="{{$festival['end_date']}}"  v-validate="'required'" data-vv-as="&quot;{{ __('festival::app.festival.end-date') }}&quot;">
