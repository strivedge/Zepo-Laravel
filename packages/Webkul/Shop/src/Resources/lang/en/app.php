...
return [
    ...
    'products' => [
        ...
        'lessthan-six-error' => 'ZipCode must have 6 digit or greater.',
        'greaterthan-ten-error' => 'ZipCode must have under 10 digit.',
        'zip-success' => 'Service available @',
        ...
        'contact' => 'Contact No.',
        'quantity' => 'Quantity',
        'select-min' => 'Select minimum quantity',
        'more-than' => 'More than',
        ...
        'basic-dis-price' => 'BASIC DIS. PRICE',
        'basic-price' => 'BASIC PRICE',
        'qty-discount' => 'QTY',
        'add-piece-to-cart' => 'ADD PIECE TO CART',
        'piece' => 'Piece',
        'price' => 'Price',
        'amount' => 'Amount',
        'piece-basic-amount' => 'Piece Basic Amount : ',
        'total-basic-amount' => 'Total Basic Amount : ',
        'total-discount-amount' => 'Total Discount Amount :',
        'total-order-qty' => 'Total Order Qty : ',
        'total-dis-basic-amount' => 'Total Dis. Basic Amount :',
    ],
