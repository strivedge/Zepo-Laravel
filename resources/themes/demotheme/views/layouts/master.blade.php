...
<html lang="{{ app()->getLocale() }}">
    ...
    <head>
        ...
        <!-- <link rel="stylesheet" href="{{ asset('themes/demotheme/assets/css/bootstrap.min.css') }}" /> -->
        <link rel="stylesheet" href="{{ asset('themes/demotheme/assets/css/google-font.css') }}" />

        <link rel="stylesheet" href="{{ asset('themes/demotheme/assets/css/bootstrap.css') }}" type="text/css" />
        <link rel="stylesheet" href="{{ asset('themes/demotheme/assets/css/style.css') }}" type="text/css" />
        <link rel="stylesheet" href="{{ asset('themes/demotheme/assets/css/boxicons.min.css') }}" type="text/css" />
        <link rel="stylesheet" href="{{ asset('themes/demotheme/assets/css/bootstrap-select.css') }}" type="text/css" />
        <link rel="stylesheet" href="{{ asset('themes/demotheme/assets/css/slick-theme.css') }}" type="text/css" />
        <link rel="stylesheet" href="{{ asset('themes/demotheme/assets/css/slick.css') }}" type="text/css" />

        @if (core()->getCurrentLocale()->direction == 'rtl')
            <link href="{{ asset('themes/demotheme/assets/css/bootstrap-flipped.css') }}" rel="stylesheet">
        @endif

        @if ($favicon = core()->getCurrentChannel()->favicon_url)
            <link rel="icon" sizes="16x16" href="{{ $favicon }}" />
        @else
            <link rel="icon" sizes="16x16" href="{{ asset('/themes/demotheme/assets/images/static/v-icon.png') }}" />
        @endif
        ...
        <!-- <script
            ...
            src="{{ asset('themes/demotheme/assets/js/jquery.min.js') }}">
        </script> -->

        <script src="{{ asset('themes/demotheme/assets/js/jquery-3.5.1.min.js') }}"></script>

        <script
            type="text/javascript"
            baseUrl="{{ url()->to('/') }}"
            src="{{ asset('themes/demotheme/assets/js/velocity.js') }}">
        </script>

        <script
            type="text/javascript"
            src="{{ asset('themes/demotheme/assets/js/jquery.ez-plus.js') }}">
        </script>
    ...
    <body @if (core()->getCurrentLocale()->direction == 'rtl') class="rtl" @endif>
        ...
        <script src="{{ asset('themes/demotheme/assets/js/bootstrap.js') }}"></script>
        <script src="{{ asset('themes/demotheme/assets/js/bootstrap.min.js') }}"></script>
        <script src="{{ asset('themes/demotheme/assets/js/bootstrap-select.js') }}"></script>
        <script src="{{ asset('themes/demotheme/assets/js/slick.min.js') }}"></script>
        <script src="{{ asset('themes/demotheme/assets/js/custom.js') }}"></script>
        <script>
            $('.carousel').carousel({
                interval: 2000
            });
