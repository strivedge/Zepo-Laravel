            ...
            <div class="navbar-top-wrapper">
                ...
                <div class="navbar-right-wrapper col-md-6">
                    <ul>
                        ...
                        <li class="country-dollars">
                            <select class="selectpicker" data-width="fit">
                                <option data-content='<span class="flag-icon"><img src="{{ asset('themes/zepomart/assets/images/united-states.svg') }}"></span> English'>English</option>
                                <option  data-content='<span class="flag-icon"><img src="{{ asset('themes/zepomart/assets/images/united-states.svg') }}"></span> English'>English</option>
                            </select>
                        </li>
                    </ul>
    ...
    <div class="navbar-middle">
        <div class="container">
            <div class="navbar-middle-wrapper">
                <a class="navbar-brand col-md-2" href="#"><img src="{{ asset('themes/zepomart/assets/images/logo.png') }}" class="custom-logo" alt="" itemprop="logo"></a>
