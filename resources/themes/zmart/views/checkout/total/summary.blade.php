<div class="order-summary fs16">
    ...
    <div class="payable-amount" id="grand-total-detail">
        ...
        <div class="col-6 fw6 prices" id="grand-total-amount-detail">
...
<div class="row checkout-buttons">
        <a
            ...
            <span class="checkout-text">{{ __('velocity::app.checkout.proceed') }}</span><span class="material-icons">arrow_right_alt</span>
        </a>
</div>