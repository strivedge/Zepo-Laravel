    ...
    <form method="post" action="{{ route('customer.address.update', $address->id) }}" @submit.prevent="onSubmit">
        ...
        <div class="account-table-content">
            ...
            <div class="control-group" :class="[errors.has('gst_number') ? 'has-error' : '']">
                ...
                <input type="text" class="control" name="gst_number" v-validate="''" value="{{ old('gst_number') ?? $address->gst_number }}" data-vv-as="&quot;{{ __('shop::app.customer.account.address.create.gst_number') }}&quot;">
