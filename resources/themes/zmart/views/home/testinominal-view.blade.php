                    ...
                    <div class="items">
                        <div class="item-inner-wrapper">
                            <div class="image-wrap">
                                ...
                                <img src="{{ asset('uploadImages/'.$testinominal->image) }}" alt="{{ $testinominal->title }}" height="100" width="100" onerror="this.src='{{ asset('vendor/webkul/ui/assets/images/product/meduim-product-placeholder.png') }}'">
                            </div>
